...
enum class Instruction: uint8_t
{
	...
	RSVJOURNAL = 0xe0, ///< Journal reference type state variable
	VSVJOURNAL,        ///< Journal value type state variable
	IRJOURNAL,             ///< Journal reference type index
	IVJOURNAL,             ///< Journal value type index
	VVJOURNAL,             ///< Journal reference type state value change
	VRJOURNAL,             ///< Journal value type state value change
